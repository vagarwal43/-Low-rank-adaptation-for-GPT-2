...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.c_attn = LoRALinear(config.n_embd, config.n_embd * 3,bias = config.bias, lora_rank=config.lora_rank, lora_alpha=config.lora_alpha, lora_dropout=config.lora_dropout)
        #TODO: Define LoRALinear

        # output projection
        self.c_proj = LoRALinear(config.n_embd, config.n_embd, bias = config.bias, lora_rank=config.lora_rank, lora_alpha=config.lora_alpha, lora_dropout=config.lora_dropout)
        #TODO: Define LoRALinear
