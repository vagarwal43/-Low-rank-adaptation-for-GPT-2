...
def get_sentiment_prompt(text, label=''):
    ...
    instruction = "Read the following text and classify it as either positive or negative sentiment To give a brief positive sentiment conveys happiness and negative sentiment conveys sadness"
